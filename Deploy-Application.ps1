...
Try {
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		If (Get-InstalledApplication -Name "7-Zip") {
			$exitCode = Remove-MSIApplications -Name "7-Zip" -PassThru
			If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
		}
		If (Test-Path "$envProgramFiles\7-Zip\Uninstall.exe") {
			$exitCode = Execute-Process -Path "$envProgramFiles\7-Zip\Uninstall.exe" -Parameters '/S' -WindowStyle 'Hidden'
			If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
		}
		...
		$exitCode = Execute-MSI -Action 'Install' -Path "$dirFiles/7z2201-x64.msi" -Parameters "/q INSTALLDIR=`"$envProgramFiles\7-Zip`"" -PassThru
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU9b8JKGe5wAwIT8hHTIwZyOKL
# t2+gghHXMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# MRYEFKgJTM5q81u8JD28YSSx0zcvVkR/MA0GCSqGSIb3DQEBAQUABIIBgIHb0ftR
# /lZpd5lRPPqY3Q1unAYfbzQmmbvCYzHxLaZsg0MMUi62vJ5b8GPDgdlfats8zGVj
# Z3BPGImXwRuVpZXvzGX1aDRigd0RQTYBJWvNslCVP9CmCS0W1+bU8KlXAawPvG/0
# DmaePZuSa5E36pKanhrVe6JpbTwWixqilZRpnFKxSBHSWRBTvJEA9jgFpydd20O4
# O93AsnFELDLR4aETlzJxl1Ebws1r5OdHwpVMkcZoKuQSByb9SczSHxPihPyXReQS
# mdNZ5C2+FRXbKGpmk03BHMyhHZaZfNds0m1ZmpDr0qn2PbHoGcIOae0YPg/pamWy
# 8wglB2chzzcTwuYxfpiToQZvDI2YO7ryjZnRr3Iys8P5GgR0Apw5heM2NTGSGXjz
# 94N9pYnUUmBCrE16eExj1lK6vLMIPl8Vj00hSXYIb68d6nepiLQXqLmSODl3JLd3
# bmEg5UlUfXBkChG+GT7eR3Ob13+JNZMikecBeINfW+dk8mPX3ValfA5AEw==
